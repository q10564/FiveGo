...
QT_MOC_LITERAL(6, 55, 6) // "getMsg"

    },
    "RequestHandler\0sendPoint\0\0MyPoint\0"
    "getStart\0getStartRes\0getMsg"
};
...
void RequestHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RequestHandler::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RequestHandler::getMsg)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void RequestHandler::getMsg(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
